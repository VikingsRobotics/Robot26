...
SwerveDrivetrain::SwerveDrivetrain(SwerveDrivetrainConstants const& drivetrainConstants, std::array<double, 4> const& odometryStandardDeviation,
    ...
    : canbus{drivetrainConstants.CANBusName},
      ...
      lastTimestamp{frc::Timer::GetTimestamp()},
      allSignals{
...
void SwerveDrivetrain::Periodic() {
    ...
    modules[0]->UpdateModuleSupplem();
    modules[1]->UpdateModuleSupplem();
    modules[2]->UpdateModuleSupplem();
    modules[3]->UpdateModuleSupplem();
